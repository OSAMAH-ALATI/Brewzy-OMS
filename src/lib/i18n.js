...
const DICT = {
  ...
  ar: {
    ...
    'Next': 'التالي',
    'Weekday': 'يوم الأسبوع',
    'Day of Month': 'اليوم من الشهر',
    'Every visit': 'كل زيارة',
    'Every 2 visits': 'كل زيارتين',
    'Every 3 visits': 'كل 3 زيارات',
    'Technician task': 'مهمة فنّي',
    'Sunday': 'الأحد',
    'Monday': 'الاثنين',
    'Tuesday': 'الثلاثاء',
    'Wednesday': 'الأربعاء',
    ...
    'Friday': 'الجمعة',
    'Saturday': 'السبت',
    'Operation Time': 'وقت التشغيل',
    'The time this machine is serviced (e.g. 8:00 AM)': 'الوقت الذي تُخدَم فيه هذه الماكينة (مثال: 8:00 صباحاً)',
    'Grant operators and technicians access to any page you choose': 'امنح المشغّلين والفنيين صلاحية الوصول لأي صفحة تختارها',
    'No pages have been granted to your account yet. Please contact your manager.': 'لم تُمنح أي صفحات لحسابك بعد. يرجى التواصل مع مديرك.',
    'Operations overview and charts': 'نظرة عامة على العمليات والرسوم البيانية',
    'View the machine list': 'عرض قائمة الماكينات',
    'View and edit maintenance tasks': 'عرض وتعديل مهام الصيانة',
    'Edit the emptying steps': 'تعديل خطوات التفريغ',
    'View machine emptying records': 'عرض سجلات تفريغ الماكينات',
    'Use the machine emptying checklist': 'استخدام قائمة تفريغ الماكينة',
    'View and manage stock': 'عرض وإدارة المخزون',
    'Suppliers and purchase orders': 'الموردون وأوامر الشراء',
